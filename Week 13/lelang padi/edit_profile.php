...
<div class="dropdown">
  <button class="btn btn-warning active " type="button" data-toggle="dropdown" style="font-size:15px;" aria-haspopup="true" aria-expanded="false">User
  <i class="fas fa-user-circle" style="font-size:15px;"></i>
  <span class="caret"></span></button>
  <ul class="dropdown-menu">
    <li style="font-size:11px;"><a href="edit_profile.php">Edit Profile</a></li>
        ...
        <div class="col-xl-4">
            ...
            <div class="card mb-4 mb-xl-0">
                ...
                <div class="card-body text-center">
                    ...
                    <img class="img-account-profile rounded-circle mb-2" src="image/user.jpg" alt="">
                    
                    <!-- Profile picture upload button-->
                    <br><button class="btn btn-warning" type="button">Unggah gambar baru</button>
                </div>
            </div>
        </div>
        <div class="col-xl-8">
